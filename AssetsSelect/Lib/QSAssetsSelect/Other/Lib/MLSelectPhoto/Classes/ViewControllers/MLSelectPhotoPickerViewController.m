...
- (void) createNavigationController{
    ...
    [nav.navigationBar setBackgroundImage:[UIImage imageWithPureColor:[UIColor redColor]] forBarPosition:UIBarPositionTopAttached barMetrics:UIBarMetricsDefault];
