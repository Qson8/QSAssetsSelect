...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else // 选中的个数没有超标超标
    {
        if (self.selectedModels.count == 0) //没选状态下
        {
            ...
            if((tempModel.type == JSAssetModelMediaTypeVideo || tempModel.type == JSAssetModelMediaTypeAudio) && tempModel.didMask) {
...
{
//    [SVProgressHUD setDefaultStyle:SVProgressHUDStyleDark];
//    [SVProgressHUD showWithStatus:[NSBundle localizedStringForKey:@"Processing..."]];
