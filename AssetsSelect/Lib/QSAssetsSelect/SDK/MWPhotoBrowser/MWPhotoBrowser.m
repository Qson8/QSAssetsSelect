...
- (void)storePreviousNavBarAppearance {
    ...
    _titleTextAttributesD = self.navigationController.navigationBar.titleTextAttributes;
...
- (void)restorePreviousNavBarAppearance:(BOOL)animated {
    if (_didSavePreviousStateOfNavBar) {
        ...
        UINavigationBar *navBar = self.navigationController.navigationBar;
        navBar.titleTextAttributes = _titleTextAttributesD;
	...
	for (NSUInteger index = (NSUInteger)iFirstIndex; index <= (NSUInteger)iLastIndex; index++) {
		if (![self isDisplayingPageForIndex:index]) {
            ...
            if (page.displayingVideo) {
                ...
                [playButton setImage:[UIImage imageNamed:@"media_play"] forState:UIControlStateNormal];
...
//                [playButton setImage:[UIImage imageForResourcePath:@"MWPhotoBrowser.bundle/PlayButtonOverlayLargeTap" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateHighlighted];
                ...
                playButton.size = CGSizeMake(kSuitFloat(80), kSuitFloat(80));
